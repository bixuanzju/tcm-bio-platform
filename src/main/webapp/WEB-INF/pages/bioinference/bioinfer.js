...
var bioinfer = {
    ...
    modifyResource : function(resource, prefix){
        var resourceArray = resource.split("/");
        return prefix + resourceArray[resourceArray.length-1];
    },
    ...
    toHtmlRowTab2 : function(bioinferData, type){
        if (type == "-1") {
            $('#tab2-table-sample-row .bio-1').html(bioinfer.modifyResource(bioinferData.drugName, ""));
            $('#tab2-table-sample-row .bio-2').html(bioinfer.modifyResource(bioinferData.drugID, "http://www.biotcm.org/drugID/"));
            $('#tab2-table-sample-row .bio-3').html(bioinfer.modifyResource(bioinferData.diseaseID, "http://www.biotcm.org/diseaseID/"));
            $('#tab2-table-sample-row .bio-4').html(bioinfer.modifyResource(bioinferData.diseaseName, "http://www.biotcm.org/diseaseName/"));
            $('#tab2-table-sample-row .bio-5').html(bioinfer.modifyResource(bioinferData.tcmName, "http://www.biotcm.org/medicine/"));
        }
        else if (type == "-2") {
            $('#tab2-table-sample-row .bio-1').html(bioinfer.modifyResource(bioinferData.geneName, "http://www.biotcm.org/gene/"));
            $('#tab2-table-sample-row .bio-2').html(bioinfer.modifyResource(bioinferData.proteinAcce, "http://www.biotcm.org/uniprot/"));
            $('#tab2-table-sample-row .bio-3').html(bioinfer.modifyResource(bioinferData.targetName, ""));
            $('#tab2-table-sample-row .bio-4').html(bioinfer.modifyResource(bioinferData.drugName, ""));
            $('#tab2-table-sample-row .bio-5').html(bioinfer.modifyResource(bioinferData.diseaseName, "http://www.biotcm.org/diseaseName/"));
            $('#tab2-table-sample-row .bio-6').html(bioinfer.modifyResource(bioinferData.tcmName, "http://www.biotcm.org/medicine/"));
        }
        else if (type == "-3") {
            $('#tab2-table-sample-row .bio-1').html(bioinfer.modifyResource(bioinferData.proteinAcce, "http://www.biotcm.org/uniprot/"));
            $('#tab2-table-sample-row .bio-2').html(bioinfer.modifyResource(bioinferData.targetName, ""));
            $('#tab2-table-sample-row .bio-3').html(bioinfer.modifyResource(bioinferData.drugName, ""));
            $('#tab2-table-sample-row .bio-4').html(bioinfer.modifyResource(bioinferData.diseaseName, "http://www.biotcm.org/diseaseName/"));
            $('#tab2-table-sample-row .bio-5').html(bioinfer.modifyResource(bioinferData.tcmName, "http://www.biotcm.org/medicine/"));
        }
        else if (type == "-4") {
            $('#tab2-table-sample-row .bio-1').html(bioinfer.modifyResource(bioinferData.goid, "http://www.biotcm.org/GO/"));
            $('#tab2-table-sample-row .bio-2').html(bioinfer.modifyResource(bioinferData.proteinAcce, "http://www.biotcm.org/uniprot/"));
            $('#tab2-table-sample-row .bio-3').html(bioinfer.modifyResource(bioinferData.targetName, ""));
            $('#tab2-table-sample-row .bio-4').html(bioinfer.modifyResource(bioinferData.drugName, ""));
            $('#tab2-table-sample-row .bio-5').html(bioinfer.modifyResource(bioinferData.diseaseName, "http://www.biotcm.org/diseaseName/"));
            ...
            $('#tab2-table-sample-row .bio-1').html(bioinfer.modifyResource(bioinferData.diseaseName, "http://www.biotcm.org/diseaseName/"));
            $('#tab2-table-sample-row .bio-2').html(bioinfer.modifyResource(bioinferData.tcmName, "http://www.biotcm.org/medicine/"));
        }
