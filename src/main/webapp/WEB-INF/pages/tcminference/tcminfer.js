...
var tcminfer = {
    ...
    toHtmlRowTab1 : function(tcmInferData){
        ...
        $('#tab1-table-sample-row .gene-name').html(tcminfer.splitResource(tcmInferData.geneName));
    ...
    toHtmlRowTab2 : function(tcmInferData){
        $('#tab2-table-sample-row .tcm-name').html(tcminfer.modifyResource(tcmInferData.tcmName, "http://www.biotcm.org/medicine/"));
        $('#tab2-table-sample-row .disease-name').html(tcminfer.modifyResource(tcmInferData.diseaseName, "http://www.biotcm.org/diseaseName/"));
        $('#tab2-table-sample-row .disease-ID').html(tcminfer.modifyResource(tcmInferData.diseaseID, "http://www.biotcm.org/diseaseID/"));
        $('#tab2-table-sample-row .drug-name').html(tcminfer.modifyResource(tcmInferData.drugName, ""));
        $('#tab2-table-sample-row .target-name').html(tcminfer.modifyResource(tcmInferData.targetName, ""));
        $('#tab2-table-sample-row .protein-acce').html(tcminfer.modifyResource(tcmInferData.proteinAcce, "http://www.biotcm.org/uniprot/"));
        $('#tab2-table-sample-row .gene-name').html(tcminfer.modifyResource(tcmInferData.geneName, "http://www.biotcm.org/gene/"));
        $('#tab2-table-sample-row .gene-prod').html(tcminfer.modifyResource(tcmInferData.geneProduct, ""));
